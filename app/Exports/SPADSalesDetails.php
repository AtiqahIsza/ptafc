...
class SPADSalesDetails implements FromView, WithStyles, ShouldAutoSize
{
    public $reports;
    public $networkArea;
    public $fromDate;
    ...
    {
        //dd($this->reports);
        return view('exports.spad.salesdetail', [
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A1:R' . $highestRow)->getAlignment()->setWrapText(true);
