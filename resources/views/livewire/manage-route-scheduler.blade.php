                    ...
                    <form wire:submit.prevent="{{ 'addScheduleRoute'}}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model.defer="state.title" class="form-control border-gray-300" id="title" type="number" placeholder="{{ __('Title of Schedule') }}" autofocus required>
                                @if ($errors->has('title'))
                    ...
                    <form wire:submit.prevent="{{ 'updateSchedule'}}">
                        ...
                        <div class="d-grid">
                            <div class="d-block mb-md-0" style="position: relative">
                                ...
                                <!-- Button Modal -->
                                <button wire:click.prevent="confirmRemoval({{ $route->id }})" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmationModal">Delete Schedule</button>
                            </div>
                        </div>
                    </form>
                </div>
