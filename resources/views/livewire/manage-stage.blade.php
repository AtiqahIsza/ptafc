<div class="main py-4">
    <div class="d-block mb-md-0" style="position: relative">
        <h2>Manage Stages</h2>
        <button wire:click.prevent="addNew" class="buttonAdd btn btn-primary d-inline-flex align-items-center me-2" data-bs-toggle="modal" data-bs-target="#modalEdit">
                    ...
                    <form wire:submit.prevent="{{ $showEditModal ? 'updateStage' : 'createStage' }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model.defer="state.stage_number" class="form-control border-gray-300" id="stageNum" placeholder="{{ __('Stage Number') }}" autofocus required>
