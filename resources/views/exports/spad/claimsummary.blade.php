<table style="border-color: #000000; border-style: solid;">
    ...
    <tbody>
        ...
        @php $newDate=false; $newRoute=false; @endphp
        @foreach($reports as $key1 => $reportValue)
            @if(!property_exists($reportValue, 'trip_code') && !property_exists($reportValue, 'service_date') && !property_exists($reportValue, 'route_number'))
                <tr>
            ...
            @elseif(!property_exists($reportValue, 'trip_code') && !property_exists($reportValue, 'service_date') && property_exists($reportValue, 'route_number'))
                <tr>
                    <td colspan="3" style="text-align: right;">
            ...
            @elseif(!property_exists($reportValue, 'trip_code') && property_exists($reportValue, 'service_date') && property_exists($reportValue, 'route_number'))
                ...
                @php $newDate=true;@endphp
            @else
                @if($newDate==true && $newRoute==false)
                    <tr>
                        <td colspan="10">&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    @php $newDate=false; @endphp
                @elseif($newDate==true && $newRoute==true)
                    <tr>
                        <td colspan="10">&nbsp;</td>
                    </tr>
                    <tr>
