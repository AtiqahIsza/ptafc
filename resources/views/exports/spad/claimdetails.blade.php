<table style="border-color: #000000; border-style: solid;">
    ...
    <tbody>
        ...
        <tr>
         ...
         @php $newTripCode=false;@endphp
        @foreach($reports as $key1 => $reportValue)
            @if(!property_exists($reportValue, 'service_date'))
                <tr>
                    <td colspan="34">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td><strong>{{ $reportValue->bus_stop_travel }}</strong></td>
                    <td><strong>{{ $reportValue->distance }}</strong></td>
                    <td><strong>{{ $reportValue->travel_claim }}</strong></td>
                    <td><strong>{{ $reportValue->travel_gps }}</strong></td>
                    <td><strong>{{ $reportValue->travel_gps_claim }}</strong></td>
                    <td colspan="13">&nbsp;</td>
            ...
            @elseif(property_exists($reportValue, 'service_date') && !property_exists($reportValue, 'route_name'))
                <tr>
                    <td colspan="11" style="text-align: right;">
            ...
            @elseif(!property_exists($reportValue, 'id') && property_exists($reportValue, 'service_date') && property_exists($reportValue, 'route_name'))
                @php $newTripCode=true;@endphp
                <tr>
                    <td colspan="11" style="text-align: right;">
                        <strong>Total ({{ $reportValue->service_date }} - {{ $reportValue->route_number }} {{ $reportValue->route_name }})</strong>
                    </td>
                    <td><strong>{{ $reportValue->bus_stop_travel }}</strong></td>
                    <td><strong>{{ $reportValue->distance }}</strong></td>
                    <td><strong>{{ $reportValue->travel_claim}}</strong></td>
                    <td><strong>{{ $reportValue->total_mileage }}</strong></td>
                    <td><strong>{{ $reportValue->travel_gps_claim }}</strong></td>
                    <td colspan="13">&nbsp;</td>
                    <td><strong>{{ $reportValue->ridership }}</strong></td>
                    <td><strong>{{ $reportValue->farebox }}</strong></td>
            ...
            @else
                ...
                <tr>
                    ...
                    <td style="text-align: center;">{{ $reportValue->trip_code_name }}</td>
                    <td style="text-align: center;">T{{ $reportValue->id }}</td>
                    <td style="text-align: center;">{{ $reportValue->service_date }}</td>
                    <td style="text-align: center;">{{ $reportValue->stage_name }}</td>
                    <td style="text-align: center;">{{ $reportValue->trip_number }}</td>
                    <td style="text-align: center;">{{ $reportValue->bus_registration_number }}</td>
                    <td style="text-align: center;">{{ $reportValue->bus_age  }}</td>
                    <td style="text-align: center;">{{ $reportValue->claim  }}</td>
                    <td style="text-align: center;">{{ $reportValue->driver_number }}</td>
                    <td>{{ $reportValue->bus_stop_travel}}</td>
                    <td>{{ $reportValue->distance }}</td>
                    <td>{{ $reportValue->travel_claim }}</td>
                    <td>{{ $reportValue->total_mileage }}</td>
                    <td>{{ $reportValue->travel_gps_claim }}</td>
                    <td style="text-align: center;">Complete</td>
                    <td style="text-align: center;"></td>
                    <td style="text-align: center;">{{ $reportValue->distance }}</td>
                    <td style="text-align: center;">{{ $reportValue->travel_claim }}</td>
                    <td style="text-align: center;"></td>
                    ...
                    <td style="text-align: center;">{{ $reportValue->punctuality }}</td>
                                        ...
                                        @else
                                            @foreach($tripInbound as $key8 => $dataIn)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{ $dataIn['status_desc'] }}</td>
                                        ...
                                        @else
                                            @foreach($tripOutbound as $key9 => $dataOut)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{ $dataOut['status_desc'] }}</td>
