<table style="border-color: #000000; border-style: solid;">
    ...
    <tr>
        <th colspan="9" style="vertical-align: middle; text-align: center;">
            <strong>Trip Planned Report</strong>
        </th>
    </tr>
    <tr>
        <th colspan="9">&nbsp;</th>
                ...
                @if($allRouteArr!=NULL)
                    <tr>
                        <td colspan="7" style="text-align: right;">
                            <strong>Grand Total Trip Planned:</strong>
                        </td>
                    ...
                    @if($allRoutes!=NULL)
                        @foreach($allRoutes as $key4 => $allDatesArr)
                            @if($key4=="total_per_route")
                                <tr>
                                    <td colspan="7" style="text-align: right;">
                                        <strong>Total Trip Planned For Route No: {{ $key3 }}</strong>
                                    </td>
                                    ...
                                    @foreach($allDates as $key6 => $allInOut)
                                        @if($key6=="total_per_date")
                                            @if($allInOut!=0)
                                                <tr>
                                                    <td colspan="7" style="text-align: right;">
                                                        <strong>Total Trip Planned For Date: {{ $key5 }}</strong>
                                                    </td>
                                        ...
                                        @else
                                            @if($allInOut!=NULL)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><strong>Trip Date</strong></td>
                                                    <td style="text-align: center;"><strong>Service Time</strong></td>
                                                ...
                                                @foreach($allInOut as $key7 => $allTrips)
                                                    @if($key7=="total_per_inbound" || $key7=="total_per_outbound")
                                                        <tr>
                                                            <td colspan="7" style="text-align: right;">
                                                                <strong>Total Trip Planned For ({{ $key5 }} - {{ $key3 }} {{ $key6 }}</strong>
                                                            </td>
