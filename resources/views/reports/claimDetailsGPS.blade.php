...
<body>
    <table class="table-bordered" >
        <thead>
        <tr>
            <th colspan="29" style="vertical-align: middle; text-align: center;">
        ...
        <tr>
            <th colspan="29">
                <strong> Reporting Period: {{ $validatedDateFrom }} - {{ $validatedDateTo }} </strong>
            </th>
        </tr>
        <tr>
            <th colspan="29">
        ...
        <tbody>
        @foreach($claimDetails as $key => $reportValue)
                                    ...
                                    @foreach($dataPerDate['inbound_data'] as $key4 => $tripInbound)
                                        ...
                                        @else
                                            @foreach($tripInbound as $key8 => $dataIn)
                                                <tr>
                                                    <td style="text-align: center;"><a style="font-weight: bold; color: rgb(52, 194, 255);" href="{{ URL::route('viewClaimDetailsGPS', $dataIn['trip_id']) }}" target="_blank">{{ $key1 }}</a></td>
                                    ...
                                    @foreach($dataPerDate['outbound_data'] as $key5 => $tripOutbound)
                                        ...
                                        @else
                                            @foreach($tripOutbound as $key9 => $dataOut)
                                                <tr>
                                                    <td style="text-align: center;"><a style="font-weight: bold; color: rgb(52, 194, 255);" href="{{ URL::route('viewClaimDetailsGPS', $dataOut['trip_id']) }}" target="_blank">{{ $key1 }}</a></td>
