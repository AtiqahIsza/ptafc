...
class CreateCompanyTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('company', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('region_region_id')->nullable()->index('FK38A73C7DF26F9C4D');
            ...
            $table->foreign(['region_region_id'], 'FK38A73C7DF26F9C4D')->references(['region_id'])->on('region_code')->onDelete('cascade');
        });
    }
