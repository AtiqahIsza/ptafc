...
class CreateCardMonthlyBalanceTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('card_monthly_balance', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('card_id')->nullable()->index('FK848EF97B1483D948');

            $table->foreign(['card_id'], 'FK848EF97B1483D948')->references(['id'])->on('ticket_card')->onDelete('cascade');
        });
    }
