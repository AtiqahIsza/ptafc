...
class CreateAgentMonthlyBalanceTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('agent_monthly_balance', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('agent_id')->nullable()->index('FK180B37701EDF5D0A');

            $table->foreign(['agent_id'], 'FK180B37701EDF5D0A')->references(['id'])->on('reload_agent')->onDelete('cascade');
        });
    }
