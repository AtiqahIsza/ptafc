...
class CreatePassengerDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('passenger_details', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('card_card_id')->nullable()->index('FK37AEB39D1483D948');
            ...
            $table->foreign(['card_card_id'], 'FK37AEB39D1483D948')->references(['card_id'])->on('ticket_card')->onDelete('cascade');
        });
    }
