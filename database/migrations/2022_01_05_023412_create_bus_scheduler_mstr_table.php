...
class CreateBusSchedulerMstrTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bus_scheduler_mstr', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('route_route_id')->nullable()->index('FK5E29F4787F2551F');
            ...
            $table->foreign(['route_route_id'], 'FK5E29F4787F2551F')->references(['route_id'])->on('route')->onDelete('cascade');
        });
    }
