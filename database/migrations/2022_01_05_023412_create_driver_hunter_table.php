...
class CreateDriverHunterTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('driver_hunter', function (Blueprint $table) {
            $table->unsignedBigInteger('hunter_id')->primary();
            ...
            $table->unsignedBigInteger('region_region_id')->nullable()->index('FK5EC3E777F26F9C4D');
            $table->string('hunter_code', 32);
            $table->dateTime('date_created')->nullable();

            $table->foreign(['region_region_id'], 'FK5EC3E777F26F9C4D')->references(['region_id'])->on('region_code')->onDelete('cascade');
