...
class CreatePassengerBoardingTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('passenger_boarding', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('bus_bus_id')->nullable()->index('FKDFE4E1417E2B6AE8');

            $table->foreign(['bus_bus_id'], 'FKDFE4E1417E2B6AE8')->references(['bus_id'])->on('bus')->onDelete('cascade');
