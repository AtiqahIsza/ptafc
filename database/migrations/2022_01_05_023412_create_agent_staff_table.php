...
class CreateAgentStaffTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('agent_staff', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('agent_agent_id')->nullable()->index('FK76EF51261EDF5D0A');

            $table->foreign(['agent_agent_id'], 'FK76EF51261EDF5D0A')->references(['agent_id'])->on('reload_agent')->onDelete('cascade');
        });
    }
